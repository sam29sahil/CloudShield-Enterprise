...
class AzureAnalyzer:
    ...
    def analyze_defender(self, defender):
        ...
        recommendations = defender.get("recommendations", {})

        if isinstance(recommendations, dict):

            recommendation_list = recommendations.get("data", [])
        ...
        if len(recommendation_list) > 20:
            ...
            self.add_finding(
                ...
                description=(
                    f"There are {len(recommendation_list)} " "security recommendations."
                ),
                recommendation=(
                    "Review and implement " "Microsoft Defender " "recommendations."
                ),
            )
