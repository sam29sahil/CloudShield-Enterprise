...
<<<<<<< HEAD
        ...
        self.value = ParagraphStyle(
            "Value", parent=self.styles["BodyText"], fontSize=10, leading=16
        )
...
<<<<<<< HEAD
    def draw_cover(self, story, report):
        ...
        story.append(Paragraph("CloudShield Enterprise", self.title_style))

        story.append(
            Paragraph("Professional Security Assessment Report", self.subtitle_style)
        )
        ...
        rows = [
            ...
            ["Status", self.clean(summary["status"])],
            ["Risk", self.clean(summary["risk"])],
            ["Security Score", f'{summary["score"]}/100'],
            ["Started", self.clean(summary["started"])],
            ["Completed", self.clean(summary["completed"])],
            ["Duration", f'{float(summary.get("duration", 0)):.2f} seconds'],
        ]
        ...
        story.append(
            Paragraph("Confidential - Generated by CloudShield Enterprise", self.footer)
        )
...
<<<<<<< HEAD
            ...
            rows.append(["No Headers", "-", "-"])

        table = Table(rows, colWidths=[3 * inch, 1.4 * inch, 1.4 * inch])
...
<<<<<<< HEAD
                    ...
                    story.append(Paragraph("No Records", self.value))

            else:

                story.append(Paragraph(self.clean(values), self.value))
...
<<<<<<< HEAD
        ...
        if not whois:
            ...
            story.append(Paragraph("WHOIS information unavailable.", self.value))
        ...
        for key, value in whois.items():
            ...
            rows.append([key.replace("_", " ").title(), self.clean(value)])
    ...
    def draw_technology(self, story, report):
        ...
        self.heading_block(story, "Technology Detection")
...
<<<<<<< HEAD
    ...
    def draw_ports(self, story, report):
        ...
        self.heading_block(story, "Open Ports")

        rows = [["Port", "Protocol", "Service", "State"]]
...
<<<<<<< HEAD
        ...
        table = Table(rows, colWidths=[1 * inch, 1.4 * inch, 2.2 * inch, 1.3 * inch])
...
<<<<<<< HEAD
        ...
        if not findings:
            ...
            story.append(Paragraph("No security findings detected.", self.value))
...
<<<<<<< HEAD
    ...
    def draw_raw_output(self, story, report):
        ...
        self.heading_block(story, "Raw Scan Output")

        raw = dict(report.get("raw", {}))

        for key in ["html", "body", "response", "cookies", "raw_html"]:
            raw.pop(key, None)
...
<<<<<<< HEAD
        ...
        canvas.drawString(30, 20, "CloudShield Enterprise v1.0")

        canvas.drawRightString(width - 30, 20, f"Page {canvas.getPageNumber()}")
