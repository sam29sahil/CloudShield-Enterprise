...
<<<<<<< HEAD
    ...
    "invalid": {
        ...
        "severity": "High",
        "cvss": 8.4,
        "description": ("The SSL certificate validation failed."),
        "recommendation": ("Install a trusted SSL certificate."),
    },
    "self_signed": {
        ...
        "recommendation": ("Replace with a certificate issued by a trusted CA."),
    },
    "weak_tls": {
        "title": "Weak TLS Version",
        "severity": "High",
        "cvss": 8.0,
        "description": ("The server supports outdated TLS protocols."),
        "recommendation": ("Disable TLS 1.0 and TLS 1.1. Use TLS 1.2 or TLS 1.3."),
    },
    "weak_cipher": {
        "title": "Weak SSL Cipher",
        "severity": "Medium",
        "cvss": 6.5,
        "description": ("Weak encryption ciphers are supported."),
        "recommendation": ("Disable weak ciphers and use strong encryption suites."),
    },
}
=======
