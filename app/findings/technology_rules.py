...
=======
    ...
    "IIS": {
        ...
        "description": (
            "Microsoft IIS Web Server detected."
        ),

        "recommendation": (
            "Keep Windows Server and IIS fully patched."
        )
    ...
    "PHP": {
        ...
        "recommendation": (
            "Keep PHP updated and disable unused modules."
        )
    ...
    "Python": {
        ...
        "description": (
            "Python-powered application detected."
        ),
    ...
    "Flask": {
        ...
        "recommendation": (
            "Keep Flask and all extensions updated."
        )
    ...
    "Django": {
        ...
        "recommendation": (
            "Apply Django security updates regularly."
        )
    ...
    "Node.js": {
        ...
        "recommendation": (
            "Update Node.js and audit npm packages."
        )
    ...
    "Express": {
        ...
        "recommendation": (
            "Update Express and middleware packages."
        )
    ...
    "Tomcat": {
        ...
        "recommendation": (
            "Keep Tomcat updated and remove default applications."
        )
    ...
    "Joomla": {
        ...
        "recommendation": (
            "Update Joomla and installed extensions."
        )
