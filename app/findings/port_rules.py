...
=======
    ...
    20: {
        ...
        "recommendation": (
            "Restrict FTP access or disable if unused."
        )
    ...
    21: {
        ...
        "recommendation": (
            "Disable anonymous FTP and restrict access."
        )
    ...
    25: {
        ...
        "recommendation": (
            "Restrict SMTP relay and monitor usage."
        )
    ...
    3306: {
        ...
        "recommendation": (
            "Restrict MySQL to internal hosts only."
        )
    ...
    8080: {
        ...
        "recommendation": (
            "Review alternate web service exposure."
        )
